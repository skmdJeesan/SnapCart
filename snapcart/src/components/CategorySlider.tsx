...
const CategorySlider = () => {
  ...
  // how to access data from redux store in client component? -> useSelector hook from react-redux
  ...
  return (
    ...
    >
      ...
      {showLeft && <button
        onClick={() => scroll('left')} 
        className="cursor-pointer active:scale-95 absolute -left-5 top-[57%] -translate-y-1/2 z-10 bg-gray-200 shadow-lg hover:bg-green-100 rounded-full w-12 h-12 flex items-center justify-center transition-all">
      ...
      {showRight && <button
        ...
        className="cursor-pointer active:scale-95 absolute -right-5 top-[57%] -translate-y-1/2 z-10 bg-gray-200 shadow-lg hover:bg-green-100 rounded-full w-12 h-12 flex items-center justify-center transition-all">
