...
const Footer = () => {
  return (
    ...
    >
      <div className='w-[90%] md:w-[85%] mx-auto py-7 grid grid-cols-1 md:grid-cols-3 gap-20 border-b border-green-500/40'>
        <div className=''>
          ...
          <div className="flex gap-4 mt-4">
            <Link href="https://facebook.com" target="_blank">
              <Facebook className="w-4 h-4 hover: text-white transition" />
            </Link>
            <Link href="https://instagram.com" target="_blank">
              <Instagram className="w-4 h-4 hover:text-white transition" />
            </Link>
            <Link href="https://twitter.com" target="_blank">
              <Twitter className="w-4 h-4 hover: text-white transition" />
            </Link>
          </div>
        </div>
        <div className=''>
